                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(12),
                      child: CustomPaint(
                        painter: _PetaniMarketChartPainter(),
                      ),
                    ),
                  ),
                  const SizedBox(height: 14),
...
class _PetaniMarketChartPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    // 1. Smooth primary green curve
